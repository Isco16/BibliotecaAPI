...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class RestriccionesIPController: ControllerBase
    {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> Put(int id, RestriccionIPCreacionDTO restriccionIPCreacionDTO)
        {
            ...
            restriccionDB.IP = restriccionIPCreacionDTO.IP;
            context.Update(restriccionDB);
            await context.SaveChangesAsync();
